    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Update Account 
				...
				<div class="row g-4 settings-section">
	                ...
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Update Account</h3>
	                ...
	                <div class="col-12 col-md-8">
						...
						<form action="{{route('settings/account/update', $accSettings->id)}}" method="POST">
							@csrf
							<div class="mb-3">
							<label for="setting-input-1" class="form-label">Payment Type</label>
								<input type="text" class="form-control" id="setting-input-1"  value="{{$accSettings->payment_type}}" name="ac_payment">
							</div>
							<div class="mb-3">
							<label for="setting-input-1" class="form-label">Account Name</label>
								<input type="text" class="form-control" id="setting-input-1" value="{{$accSettings->ac_name}}" name="ac_name">
							</div>
							<div class="mb-3">
								<label for="setting-input-2" class="form-label">Account Number</label>
								<input type="text" class="form-control" id="setting-input-2" name="ac_no" value="{{$accSettings->ac_no}}">
							</div>
							<div class="mb-3">
								<label for="setting-input-2" class="form-label">Bank</label>
								<input type="text" class="form-control" id="setting-input-1" name="ac_bank" value="{{$accSettings->ac_bank}}">
							</div>
							<div class="pb-5">
